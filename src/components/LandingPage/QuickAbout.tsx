    ...
    <section className="bg-white py-10 md:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-blue-50 p-8 md:p-10">
          ...
          <p className="text-xs sm:text-sm font-bold tracking-[0.2em] uppercase text-blue-700 mb-3">About Sreenidhi Deccan Football Club</p>
          ...
          <p className="text-slate-700 text-base md:text-lg leading-relaxed max-w-4xl">
            Sreenidhi Deccan Football Club is one of India&apos;s most ambitious football projects, known for disciplined play,
